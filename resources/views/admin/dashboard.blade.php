...
@section('styles')
<!-- Apex css -->
<link href="{{ asset('admin\plugins\apexcharts\apexcharts.css') }}" rel="stylesheet" type="text/css">
<!-- jvectormap css -->
<link href="{{ asset('admin\plugins\jvectormap\jquery-jvectormap-2.0.2.css')}}" rel="stylesheet" type="text/css">
@endsection
@section('content')
 <!-- Start Breadcrumbbar --> 
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-6 col-xl-5 text-center">                                                
                                    <img src="{{ asset('admin\images\ecommerce\storage.png') }}" class="img-fluid" alt="storage">
                        ...
                        <div class="card-body">
                            <div class="best-product-slider">
                                <div class="best-product-slider-item">
                                    <div class="row">
                                        <div class="col-4">
                                            <img src="{{ asset('admin\images\ecommerce\produc_slider_01.png') }}" class="img-fluid" alt="product">
                                        </div>
                                        <div class="col-8">
                                ...
                                <div class="best-product-slider-item">
                                    <div class="row">
                                        <div class="col-4">
                                            <img src="{{ asset('admin\images\ecommerce\produc_slider_02.png') }}" class="img-fluid" alt="product">
                                        </div>
                                        <div class="col-8">
                                ...
                                <div class="best-product-slider-item">
                                    <div class="row">
                                        <div class="col-4">
                                            <img src="{{ asset('admin\images\ecommerce\produc_slider_03.png') }}" class="img-fluid" alt="product">
                                        </div>
                                        <div class="col-8">
...
<script type="text/javascript" src="{{ asset('admin\plugins\apexcharts\irregular-data-series.js') }}"></script>
<!-- Vector Maps js -->
<script type="text/javascript" src="{{ asset('admin\plugins\jvectormap\jquery-jvectormap-2.0.2.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('admin\plugins\jvectormap\jquery-jvectormap-world-mill-en.js') }}"></script>
<!-- Dashboard js -->
<script src="{{ asset('admin\js\custom\custom-dashboard-ecommerce.js')}}"></script>
@endsection